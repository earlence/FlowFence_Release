...
import edu.umich.oasis.service.Sandbox;

import static org.xmlpull.v1.XmlPullParser.*;

/**
 * Created by jpaupore on 1/7/16.
 */
public final class Policy {
    ...
    public static boolean checkSink(TaintSet ts, SinkRequest request) {
        ...
        for (ComponentName taintName : amounts.keySet()) {
            PackageManifest manifest = OASISApplication.getInstance().getManifestForPackage(taintName.getPackageName());
            if (manifest == null) {
