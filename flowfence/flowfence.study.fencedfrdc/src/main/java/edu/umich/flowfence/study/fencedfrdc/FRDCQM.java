 ...
 */
public class FRDCQM implements Parcelable
{
    private static final String TAG = "FRDCQM";
    ...
    public static final Parcelable.Creator<FRDCQM> CREATOR = new Parcelable.Creator<FRDCQM>()
    {
        public FRDCQM createFromParcel(Parcel in) {
            return new FRDCQM(in);
        }

        public FRDCQM[] newArray(int size) {
            return new FRDCQM[size];
        }
    };

    private FRDCQM(Parcel in)
    {
