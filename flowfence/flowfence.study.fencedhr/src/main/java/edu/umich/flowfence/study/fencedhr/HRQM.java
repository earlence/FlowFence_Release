...
public class HRQM implements Parcelable
{
    private static final String TAG = "HRQM";
    ...
    static void tput()
    {
        SharedPreferences myprefs = FlowfenceContext.getInstance().getSharedPreferences(TPUTKV, 0);
    ...
    public static final Parcelable.Creator<HRQM> CREATOR = new Parcelable.Creator<HRQM>()
    {
        public HRQM createFromParcel(Parcel in) {
            return new HRQM(in);
        }

        public HRQM[] newArray(int size) {
            return new HRQM[size];
        }
    };

    private HRQM(Parcel in)
    {
