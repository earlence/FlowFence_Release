...
public class QMDetails implements Parcelable {
    private static final String TAG = "FF.QMDetails";
    private static final boolean localLOGV = Log.isLoggable(TAG, Log.VERBOSE);
    private static final boolean localLOGD = Log.isLoggable(TAG, Log.DEBUG);

    public QMDescriptor descriptor;
    ...
    public void copyFrom(QMDetails other) {
    ...
    public static final Creator<QMDetails> CREATOR = new Creator<QMDetails>() {
        @Override
        public QMDetails createFromParcel(Parcel in) {
            QMDetails sd = new QMDetails();
            sd.readFromParcel(in);
            return sd;
        }

        @Override
        public QMDetails[] newArray(int size) {
            return new QMDetails[size];
        }
    };
}
