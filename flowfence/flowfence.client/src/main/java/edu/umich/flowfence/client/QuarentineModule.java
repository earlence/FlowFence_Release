...
public class QuarentineModule<TResult> {
    ...
    private final IQM hQM;
    private final int numOutExpected;
    //private final Class<?> declaringClass;
    private final QMDescriptor descriptor;
    private final ClassLoader loader;

    public QuarentineModule(IQM hQM, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
        this(hQM, null, clazz);
    }

    public QuarentineModule(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
        this(hQM, details, clazz, QuarentineModule.class.getClassLoader());
    }

    public QuarentineModule(IQM hQM, Class<TResult> clazz, ClassLoader loader) throws RemoteException, ClassNotFoundException {
        this(hQM, null, clazz, loader);
    }

    public QuarentineModule(IQM hQM, QMDetails details, Class<TResult> clazz, ClassLoader loader) throws RemoteException, ClassNotFoundException {
        this.hQM = hQM;

        if (details == null) {
            details = new QMDetails();
            hQM.getDetails(details);
        }

        // First, let's see if this actually is compatible.
        // This will throw ClassNotFound or ClassCast if we aren't.
        this.loader = loader;
        resultClass = checkClass(hQM.getResultType(), clazz, loader);
        // Then, fill in param info.
        paramInfo = Collections.unmodifiableList(hQM.getParamInfo());
    ...
    protected class CallRunnerImpl implements CallRunner<TResult> {
        ...
        private IHandle execRemote() throws RemoteException {
            CallResult result = hQM.call(flags, callParams, (taints == null) ? TaintSet.EMPTY : taints.build());
            // Handle out refs.
            ...
            for (int i = 0; i < outResults.size(); i++) {
                ...
                if (sealed != null) {
                    ...
                    Log.w("FF.Client", "Ignoring unwanted out handle");
                    handle.release();
                }
            }
            return hReturn;
        ...
        public CallRunner<TResult> forceSandbox(int sandbox) {
            if (sandbox < 0 || sandbox >= FlowfenceConstants.NUM_SANDBOXES) {
    ...
    public static final class S0<TResult> extends QuarentineModule<TResult> implements CallRunner<TResult> {
        /*package*/ S0(IQM qm, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(qm, details, clazz);
        }
        @Override
        public Sealed<TResult> call() throws RemoteException {
    ...
    public static class SArgBase<TResult, TFirst, TRest extends CallBuilder>
            extends QuarentineModule<TResult>
            implements ArgBuilder<TFirst, TRest> {
        protected SArgBase(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    ...
    public static final class S1<T1, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S1(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
    ...
    public static final class S2<T1, T2, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S2(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
    ...
    public static final class S3<T1, T2, T3, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S3(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
    ...
    public static final class S4<T1, T2, T3, T4, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S4(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
    ...
    public static final class S5<T1, T2, T3, T4, T5, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S5(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
    ...
    public static final class S6<T1, T2, T3, T4, T5, T6, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S6(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
    ...
    public static final class S7<T1, T2, T3, T4, T5, T6, T7, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S7(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
    ...
    public static final class S8<T1, T2, T3, T4, T5, T6, T7, T8, TResult> extends SArgBase<TResult,
        ...
        /*package*/ S8(IQM hQM, QMDetails details, Class<TResult> clazz) throws RemoteException, ClassNotFoundException {
            super(hQM, details, clazz);
        }
    }
}
