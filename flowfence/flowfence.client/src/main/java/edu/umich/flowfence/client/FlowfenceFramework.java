 ...
 */
public final class FlowfenceFramework
{
    ...
    public static synchronized ComponentName getServiceComponent(Context ctx) {
        if (g_mServiceComponent == null) {
            String componentName = ctx.getString(R.string.flowfence_component_name);
    ...
    public static synchronized void install(final Context context) {
        ...
        try {
            ...
            Log.e(TAG, "FlowFence multidex installation failure", e);
            ...
            DialogInterface.OnClickListener clickListener = new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (which == DialogInterface.BUTTON_NEGATIVE) {
                        ...
                        String uri = res.getString(R.string.flowfence_install_intent);
                        try {
            ...
            if (e instanceof NameNotFoundException) {
                dbuilder.setTitle(R.string.flowfence_framework_missing_title)
                        .setNeutralButton(R.string.flowfence_framework_install, clickListener);
                messageRes = R.string.flowfence_framework_missing_message;
            } else {
                dbuilder.setTitle(R.string.flowfence_framework_error_title);
                messageRes = R.string.flowfence_framework_error_message;
            }
            dbuilder.setIcon(android.R.drawable.ic_dialog_alert)
                    .setMessage(res.getString(messageRes,
                            context.getApplicationInfo().loadLabel(context.getPackageManager()),
                            Log.getStackTraceString(e)))
                    .setPositiveButton(R.string.flowfence_framework_continue, clickListener)
                    .setNegativeButton(R.string.flowfence_framework_force_close, clickListener)
                    .show();
        }
